...
<body>
<div id="title"><div class="titleRight"><h1 style="width: 150px;"><strong>添加商户品牌信息</strong></h1></div></div>
<div id="main-div">
	<div id="mainRight">
		<form method="post" name="addShopBrandForm" id="addShopBrandForm" action="addShopBrand.action">
		
		<div class="modifyItem">
			
		</div>
		<fieldset class="modifySet">
			<legend>商户品牌基本信息</legend>
			<div class="modifyItem modifyItemFloat">
				<label for="name">品牌：</label><input type="text" name="brand" id="brand"  value="<s:property value='brand'/>" />
			</div>
			<div class="modifyItem modifyItemFloat">
				<label for="name">所属商户：</label>
				<select name="shopId" id="shopId">
					<option value="0">商户1</option>
					<option value="1">商户2</option>
				</select>
			</div>
			<div class="clear"></div>
			<div class="modifyItem">
