...
<div id="title">
	<div class="titleRight">
		<h1 style="width: 125px;"><strong>积分兑换</strong></h1>
	</div>
</div>
<div id="main-div">
	<div id="mainRight">
		...
		<h1 id="actionBanner">		
			<span class="action-span" style="color:#FF0000;">
				您已兑换礼品<s:property value="giftCount"/>份，共花费<s:property value="spanScore"/>积分,剩余<s:property value="balanceScore"/>积分；感谢您的光临，谢谢！5秒后自动跳转到会员查询界面。
			</span>
			<div class="clear"></div>
		</h1>
		</form>
